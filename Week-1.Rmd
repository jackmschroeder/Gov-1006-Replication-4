...
# I keep most of Enos' code here (since I'm not familiar enough with for loops and base R plotting). I'm curious to see if anyone was able to regenerate the plots using ggplot, but for now, I want to largely stick with what Enos does.
...
##name graphs
	if(i == 7){
		...
		pdf(paste('figures/Figure_A1',use.letters[i],'.pdf',sep=''))
		}			
	par(las = 1)
